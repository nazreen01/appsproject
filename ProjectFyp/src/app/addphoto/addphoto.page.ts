...
export class AddphotoPage {
    ...
    this.imageCollection = database.collection<MyData>('photoStorage');
  ...
  uploadFile(event: FileList) {
    ...
    // The storage path
    const path = `photoStorage/${new Date().getTime()}_${file.name}`;

    // Totally optional metadata
    const customMetadata = { app: 'Photo Image Upload Demo' };
